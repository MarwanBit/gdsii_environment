...
% >>  makemex
%
% at the MATLAB or Octave command prompt. If a C++ compiler is not
% installed, the 
%
% >> makemex-gpc
%
% should be used instead so that the General Polygon Clipper (GPC)
% library is used for Boolean set operations. In Linux/Unix the MEX
% functions can be compiled for Octave by running
%
% ./makemex-octave
%
% at the command line.
