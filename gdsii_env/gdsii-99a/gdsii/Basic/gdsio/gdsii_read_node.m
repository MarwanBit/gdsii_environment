function [gel] = gdsii_read_node(gf);
%
% read a node element and return an element object
...
while 1
  ...
  switch rtype
   ...
   otherwise
       error('corrupted or invalid node element data in GDS file.');
  end
end

gel = gds_element('node', data);
