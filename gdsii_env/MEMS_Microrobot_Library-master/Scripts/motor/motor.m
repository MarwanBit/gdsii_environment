...
if h_motor.num_inch_sets >1
    ...
    additional_serpentine_bot = [pts_bot(1:4,:)-[pts_bot(5,1)-pts_bot(1,1) 0];pts_bot(1:4,:)-[pts_bot(5,1)-pts_bot(1,1) 0]; pts_bot];
     ...
     additional_serpentine_top = [pts_top;pts_bot];
end
